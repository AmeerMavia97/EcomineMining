          ...
          <div className='absolute overflow-hidden bg-[#22c55e]  blur-[139px]  -right-10 h-[160px] w-[160px]'></div>
                ...
                <div className="text-center flex flex-col justify-center items-center">
                            <div className=' text-white'>
                                <h1 className='font-[600] text-[44px] leading-[53px]'><span className='bg-gradient-to-r from-green-500 to-green-500 bg-clip-text text-transparent'>Visit </span>Our Location</h1>
                            </div>

                            <p className="mt-3 text-[14px] w-[35%] text-gray-300">
                ...
                <div className="mt- grid grid-cols-1 gap-8 md:grid-cols-2 lg:mt-12 ">
                    ...
                    {/* Location Details */}
                    <div className="flex h-full flex-col   overflow-hidden mt-7 ">
                        {/* Address Section */}

                        
                        <div className="flex items-center space-x-4 pb-6">
                            <MapPin className="h-12 w-12 flex-shrink-0 text-white bg-[#1c8337] px-2 py-2 rounded-full" />
                            <div>
                                <h3 className="text-[22px] font-semibold text-white">
                                    Our Address
                                </h3>
                                <p className=" text-gray-400 text-[14px] w-[70%]">
                        ...
                        <div className="flex items-start space-x-4 pb-6">
                            <Clock className="h-12 w-12 flex-shrink-0 text-white bg-[#1c8337] px-2 py-2.5 rounded-full"  />
                            <div>
                        ...
                        <div className="flex flex-grow items-start space-x-2">
                            <div className="flex flex-col space-y-6">
                                <div className="flex items-center space-x-4">
                                    <Mail className="h-12 w-12 flex-shrink-0 text-white bg-[#1c8337] px-2 py-2.5 rounded-full"  />
                                    <div>
                                ...
                                <div className="flex items-start space-x-4">
                                    <Phone className="h-12 w-12 flex-shrink-0 text-white bg-[#1c8337] px-2 py-[11px] rounded-full"  />
                                    <div>
                    ...
                    <div className="relative h-[500px] w-full overflow-hidden border border-gray-800 shadow-2xl md:h-[380px] rounded-[10px]">
                        <iframe
